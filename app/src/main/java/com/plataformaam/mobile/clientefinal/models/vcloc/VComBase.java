 ...
 */
public class VComBase implements Serializable {
    int id;
    String
        name,
        description;
    ...
    List<UPIAggregationRuleStart> publishRules;
    ...
    public List<UPIAggregationRuleStart> getPublishRules() {
        return publishRules;
    }

    public void setPublishRules(List<UPIAggregationRuleStart> publishRules) {
